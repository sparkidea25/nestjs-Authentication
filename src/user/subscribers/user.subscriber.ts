import { UtilsProvider } from "src/auth/providers/utils.providers";
import {EntityRepository, EntitySubscriberInterface, EventSubscriber, InsertEvent, UpdateEvent} from "typeorm";
...
export class UserSubscriber implements EntitySubscriberInterface<UserEntity> {
    ...
    public async beforeInsert({entity,}: InsertEvent<UserEntity>): Promise<void> {
        if(entity.password) {
